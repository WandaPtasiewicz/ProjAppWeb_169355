...
<div class = "mainmenu"> <h1>PaneL CMS</h1> </div>
<div class = "lewy">
...
<div class = "prawy">  <div class="l">
    <?php
    include('C:\xampp2\htdocs\proj2\lab12\php\showproducts.php');
    PokazProdukty();
    include('C:\xampp2\htdocs\proj2\lab12\php\shoppingcart.php');
    ?>
</div>
    <div class="p">
